...
ActiveRecord::Schema.define(version: 20160622195826) do
  ...
  add_index "qbwc_jobs", ["company"], name: "index_qbwc_jobs_on_company"
  add_index "qbwc_jobs", ["name"], name: "index_qbwc_jobs_on_name", unique: true
